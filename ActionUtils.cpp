...
void ActionUtils::setActionValues() {
    ...
    //move
    actionValues[actions::Move][0] = 0.25;
    actionValues[actions::Move][1] = 0.25;
    actionValues[actions::Move][2] = 0.25;
    actionValues[actions::Move][3] = 0.25;
    ...
    actionValues[actions::Equip_Item][0] = 0.5;
    actionValues[actions::Equip_Item][1] = 0.5;
